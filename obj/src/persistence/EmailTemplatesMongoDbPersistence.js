...
exports.EmailTemplatesMongoDbPersistence = void 0;
const pip_services3_commons_nodex_1 = require("pip-services3-commons-nodex");
const pip_services3_commons_nodex_2 = require("pip-services3-commons-nodex");
const pip_services3_mongodb_nodex_1 = require("pip-services3-mongodb-nodex");
class EmailTemplatesMongoDbPersistence extends pip_services3_mongodb_nodex_1.IdentifiableMongoDbPersistence {
    constructor() {
    ...
    getOneByIdOrName(correlationId, idOrName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (item == null) {
                throw new pip_services3_commons_nodex_2.NotFoundException(correlationId, 'EMAIL_TEMPLATE_NOT_FOUND', 'Email template ' + idOrName + ' was not found').withDetails('id_or_name', idOrName);
            }
...
exports.EmailTemplatesMongoDbPersistence = EmailTemplatesMongoDbPersistence;
//# sourceMappingURL=EmailTemplatesMongoDbPersistence.js.map